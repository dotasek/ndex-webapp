...
// 'use strict';
   ...
   * @example
   ...
   it('should apply the right class to the element', function () {
        element(by.styles('.blah')).getCssValue('border')
          .then(function(c) {
...
.directive('uiGridVisible', function uiGridVisibleAction() {
  return function ($scope, $elm, $attr) {
    $scope.$watch($attr.uiGridVisible, function (visible) {
        // $elm.styles('visibility', visible ? 'visible' : 'hidden');
...
(function() {
  ...
  module.service('uiGridInfiniteScrollService', ['gridUtil', '$compile', '$timeout', 'uiGridConstants', 'ScrollEvent', '$q', function (gridUtil, $compile, $timeout, uiGridConstants, ScrollEvent, $q) {
    ...
    var service = {
        ...
        var publicApi = {
          ...
          methods: {
            infiniteScroll: {
               ...
               * whether there are still more views in each direction.
               * 
               ...
               * @param {boolean} scrollUp if set to false flags that there are no more views upwards, so don't fire
               * any more infinite scroll events upward
               * @param {boolean} scrollDown if set to false flags that there are no more views downwards, so don't
               ...
               * planning to remove views, you should wait on this promise first, or you'll break the scroll positioning
               */
               ...
               * 
               * @param {boolean} scrollUp flag that there are views upwards, fire
               * infinite scroll events upward
               * @param {boolean} scrollDown flag that there are views downwards, so
               ...
               * @param {boolean} scrollUp whether there are views available up - defaults to false
               * @param {boolean} scrollDown whether there are views available down - defaults to true
               */
       ...
       * and whether there are more views upwards or downwards.  It also stores the number of rows that we had previously,
      ...
      adjustInfiniteScrollPosition: function (grid, percentage) {
        ...
        //for infinite scroll, if there are views upwards then never allow it to be at the zero position so the up button can be active
            ...
            post: function ($scope, $elm, $attrs, uiGridCtrl) {
              ...
              if ($scope.col.colDef.enableColumnMoving) {
                ...
                var moveElement = function (changeValue) {
                  ...
                  //Update styles of moving column to adjust to new left value or fire scroll in case column has reached edge of grid
          ...
          var publicApi = {
            ...
            methods: {
              pagination: {
                 ...
                 * @name getTotalPages
                 * @methodOf ui.grid.pagination.api:PublicAPI
                 * @description Returns the total number of views
                 */
