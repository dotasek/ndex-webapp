		...
		action: function(){
			...
			if (urlPrompt && urlPrompt !== '' && urlPrompt !== 'https://') {
				...
				if(videoId){
					...
					var embed = '<images class="ta-insert-video" src="https://images.youtube.com/vi/' + videoId + '/hqdefault.jpg" ta-insert-video="' + urlLink + '" contenteditable="false" allowfullscreen="true" frameborder="0" />';
					// insert
