...
describe('HTML', function() {
  ...
  it('should ignore back slash as escape', function() {
    expectHTML('<images alt="xxx\\" title="><script>....">').
      toEqual('<images alt="xxx\\" title="&gt;&lt;script&gt;...."/>');
  });
  ...
  describe('uri checking', function() {
    beforeEach(function() {
      this.addMatchers({
        ...
        toBeValidImageSrc: function() {
          ...
          var input = '<images src="'+this.actual+'"/>';
          return sanitize(input) === input;
        }
      });
    });
    ...
    it('should use $$sanitizeUri for links', function() {
      ...
      inject(function() {
        ...
        expectHTML('<images src="someUri"/>').toEqual('<images src="someUri"/>');
        expect($$sanitizeUri).toHaveBeenCalledWith('someUri', true);

        $$sanitizeUri.andReturn('unsafe:someUri');
        expectHTML('<images src="someUri"/>').toEqual('<images/>');
      });
    });
